...
// checks if the DockerDetailsPOST type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerDetailsPOST{}
...
func (o DockerDetailsPOST) ToMap() (map[string]interface{}, error) {
