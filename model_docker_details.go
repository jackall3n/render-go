...
func (v NullableDockerDetails) Get() *DockerDetails {
	return v.value
}

func (v *NullableDockerDetails) Set(val *DockerDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerDetails(val *DockerDetails) *NullableDockerDetails {
	return &NullableDockerDetails{value: val, isSet: true}
}

func (v NullableDockerDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
